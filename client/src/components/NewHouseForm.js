      ...
      <h1 class="my-10 text-xl">{title}</h1>
        ...
        <div className="container">
          <form onSubmit={handleSubmit}>
              ...
              <button class="mt-7 ml-25 bg-yellow-400 text-black text-sm leading-6 font-medium py-2 px-3 rounded-xl fa-solid fa-arrow-right mb-20 hover:bg-yellow-600 duration-300 " type="submit"  onChange={handleSubmit}>Submit</button>
